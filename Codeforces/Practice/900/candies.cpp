...
// Notice that ∑i=0k−12i=2k−1. 
// Thus we can replace the initial equation with the following: (2k−1)x=n. 
// So we can iterate over all possible k in range [2;29] (because 230−1>109) 
// and check if n is divisible by 2k−1. 
// If it is then we can print x=n2k−1.
